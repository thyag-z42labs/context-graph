...
class ProjectRenderer:
    ...
    def _context(self) -> dict:
        ...
        return {
            ...
            "effective_agent_provider": self.config.effective_agent_provider,
            "agent_model": self.config.agent_model or "",
            "default_agent_model": self.config.default_agent_model,
            "agent_fallback_provider": self.config.agent_fallback_provider,
            "openrouter_api_key": self.config.openrouter_api_key or "",
            "openrouter_api_base": self.config.openrouter_api_base,
            "openrouter_app_url": self.config.openrouter_app_url or "",
            "openrouter_app_title": self.config.openrouter_app_title or self.config.project_name,
    ...
    def _render_backend(self, backend_dir: Path, ctx: dict) -> None:
        ...
        shared_templates = {
            ...
            "backend/shared/agent_provider.py.j2": "app/agent_provider.py",
